export const contact = {
  properties: [
    ...
    {
      name: 'hs_email_optout_439063543',
    ...
    {
      name: 'hs_email_optout_439063544',
    ...
    },
    {
      ...
      options: [
        ...
        {
          label:
            'Microsoft Undeliverable - Microsoft reports that address is inactive',
          value: 'MICROSOFT_UNDELIVERABLE',
          displayOrder: 10,
          hidden: false,
        },
      ],
    ...
    },
    {
      ...
      type: 'datetime',
      description: 'Date first order was closed. Set Automatically',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      options: [
        {
          label: 'Legitimate interest - Lead',
        ...
        {
          label: 'Legitimate interest - Customer',
    ...
    },
    {
      ...
      type: 'datetime',
      description: 'The last date a contact accessed private content',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'string',
      description:
        'This property is used to capture the push notification token for use on the LiveChat mobile sdk. We intend to use this property to store a list of push tokens (as they refresh) on the CONTACT object.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      description:
        'The coordinates of the last activity for a contact. This is set automatically by HubSpot based on user actions in the contact record.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'object_coordinates',
      description:
        'The coordinates of the next upcoming activity for a contact. This is set automatically by HubSpot based on user actions in the contact record.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'number',
      description:
        'This is a temporary property that will keep the probability that a contact will become a customer within the next 90 days. This property will be used to test a migration, which will be deleted later on after migration is completed.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'enumeration',
      description:
        'This is a temporary property to keep track of a  ranking system of contacts evenly assigned into four tiers. The property is added for a migration process and will be deleted after migration completed.',
      options: [
        {
          label: 'Very High',
          value: 'tier_1',
    ...
    },
    {
      ...
      type: 'number',
      description:
        'The number of active prospecting agent enrollments this contact has. This should be either 0 or 1',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'datetime',
      description: 'Date last order was closed. Set automatically.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'number',
      description: 'Whether or not a contact is registered',
      options: [],
      calculated: true,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'string',
      description: 'The method used for registration',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
