export const deal = {
  properties: [
    ...
    },
    {
      ...
      label: 'Latest Source Data 1 Company',
      type: 'string',
      description:
    ...
    },
    {
      ...
      label: 'Latest Source Data 1 Contact',
      type: 'string',
      description:
    ...
    },
    {
      ...
      label: 'Latest Source Data 2 Company',
      type: 'string',
      description:
    ...
    },
    {
      ...
      label: 'Latest Source Data 2 Contact',
      type: 'string',
      description:
        'Additional source details of the last session attributed to any contacts that are directly associated with this deal',
      options: [],
    ...
    },
    {
      ...
      label: 'Latest Source Timestamp Company',
      type: 'datetime',
      description:
    ...
    },
    {
      ...
      label: 'Latest Source Timestamp Contact',
      type: 'datetime',
      description:
    ...
    },
    {
      ...
      type: 'enumeration',
      description:
        'The deal type of the associated Shared Deal. (This field is only accurate on Partner portals!)',
      options: [
        {
          label: 'Channel',
          value: 'CHANNEL',
        ...
        {
          label: 'Partner Collab',
          value: 'COLLAB',
          displayOrder: 3,
          hidden: false,
        },
        {
          label: 'Collab or DIFM',
          value: 'COLLAB_OR_DIFM',
          displayOrder: 4,
          hidden: false,
        },
      ],
    ...
    },
    {
      ...
      type: 'enumeration',
      description:
        'The most likely HubSpot product(s) of the deal synced from the associated Shared Deal. (This field is only accurate on Partner portals!)',
      options: [
        {
    ...
    {
      name: 'hs_date_entered_appointmentscheduled',
    ...
    {
      name: 'hs_date_entered_closedlost',
    ...
    {
      name: 'hs_date_entered_contractsent',
    ...
    {
      name: 'hs_date_entered_decisionmakerboughtin',
    ...
    {
      name: 'hs_date_entered_presentationscheduled',
    ...
    {
      name: 'hs_date_exited_appointmentscheduled',
    ...
    {
      name: 'hs_date_exited_closedlost',
    ...
    {
      name: 'hs_date_exited_contractsent',
    ...
    {
      name: 'hs_date_exited_decisionmakerboughtin',
    ...
    {
      name: 'hs_date_exited_presentationscheduled',
    ...
    {
      name: 'hs_date_exited_qualifiedtobuy',
    ...
    },
    {
      ...
      type: 'enumeration',
      description:
        'Currency code for the MRR of the quote purchased for this Shared Deal.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'bool',
      description:
        'True if the deal is missing conditional stage property values required to progress to the next deal stage.  This is set automatically by HubSpot based on user actions in the deal record.',
      options: [
        {
          label: 'Yes',
          value: 'true',
    ...
    },
    {
      ...
      type: 'number',
      description:
        'This property is 1 if the deal is closed ("Closed Won" or "Closed Lost"), otherwise 0',
      options: [],
      calculated: true,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'bool',
      description:
        'True if the deal is in the closed lost state, false otherwise',
      options: [
        {
          label: 'True',
          value: 'true',
    ...
    },
    {
      ...
      type: 'bool',
      description:
        'True if the deal is in the first stage of its pipeline. This is set automatically by HubSpot based on user actions in the deal record.',
      options: [
        {
          label: 'Yes',
          value: 'true',
    ...
    },
    {
      ...
      type: 'string',
      description:
        'The latest approval status. Used by HubSpot to track pipeline approval processes.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'number',
      description:
        'The ID of the approval object containing the latest approval status.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'enumeration',
      description:
        'The list of Deal record IDs that have been merged into this Deal. This value is set automatically by HubSpot.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'datetime',
      description: 'Timestamp of the most recent update to Next Step property',
      options: [],
      calculated: true,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      description:
        'The coordinates of the last activity for a deal. This is set automatically by HubSpot based on user actions in the deal record.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'object_coordinates',
      description:
        'The coordinates of the next upcoming activity for a deal. This is set automatically by HubSpot based on user actions in the deal record.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'number',
      description: 'Create date populated only if this deal is open',
      options: [],
      calculated: true,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'enumeration',
      description:
        'Additional teams whose users can access the Deal based on their permissions. This can be set manually or through Workflows or APIs.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'enumeration',
      description:
        'Additional users that can access the Deal based on their permissions. This can be set manually or through Workflows and APIs.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    {
      name: 'hs_time_in_decisionmakerboughtin',
    ...
    {
      name: 'hs_time_in_presentationscheduled',
    ...
    {
      name: 'hs_time_in_qualifiedtobuy',
    ...
    },
    {
      ...
      type: 'number',
      description:
        'The number of times a call, chat conversation, LinkedIn message, postal mail, meeting, sales email, SMS, or WhatsApp message was logged for a deal record. This is set automatically by HubSpot based on user actions in the deal record.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
    ...
    },
    {
      ...
      type: 'number',
      description:
        'The number of times a call, chat conversation, LinkedIn message, postal mail, meeting, note, sales email, SMS, task, or WhatsApp message was logged for a deal record. This is set automatically by HubSpot based on user actions in the deal record.',
      options: [],
      calculated: false,
      hasUniqueValue: false,
      hubspotDefined: true,
