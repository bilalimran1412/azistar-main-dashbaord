...
const { createCustomer, updateCustomerStatus, getCustomerData, getCustomerChatData, getEmailData, deleteCustomer, sendTranscript, updateUserId} = require('../handlers/customerHandler');
